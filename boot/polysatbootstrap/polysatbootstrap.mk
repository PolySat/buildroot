...
define POLYSATBOOTSTRAP_INSTALL_HOOK
	...
	$(MAKE) CROSS_COMPILE=$(TARGET_CROSS) DFL_IMAGE_DIR=$(2) DFL_KERN=linux-kernel.bin DFL_FS=rootfs.bin DFL_LOCAL_FS=$(USRLOCAL_FILE_NAME) -C $(POLYSATBOOTSTRAP_DIR)
	...
	cp $(POLYSATBOOTSTRAP_DIR)/intrepid_at91sam9g20ek-flightboard.bin $(2)/bootstrap-intrepid-128mb.bin
	cp $(POLYSATBOOTSTRAP_DIR)/intrepid_at91sam9g20ek-intrepid1.5.bin $(2)/bootstrap-intrepid1.5.bin
	rm -f $(2)/.sed_script
	...
	echo s/intrepid_at91sam9g20ek-intrepid1.5/bootstrap-intrepid1.5/g >> $(2)/.sed_script
	...
	sed -f $(2)/.sed_script $(POLYSATBOOTSTRAP_DIR)/intrepid_at91sam9g20ek-intrepid-64.tcl > $(2)/flash-intrepid-64mb.tcl
	sed -f $(2)/.sed_script $(POLYSATBOOTSTRAP_DIR)/intrepid_at91sam9g20ek-intrepid1.5.tcl > $(2)/flash-intrepid1.5.tcl
	...
	#sed -e s/bootstrap-devboard-64mb/bootstrap-devboard-128mb/g $(2)/intrepid_at91sam9g20ek-intrepid1.5.sh > $(2)/flash-devboard-128mb.sh
	rm $(2)/.sed_script
endef
