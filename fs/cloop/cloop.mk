...
USR_LOCAL_CLOOP_DEPENDENCIES = host-cloop host-cdrkit

define ROOTFS_CLOOP_CMD
	$(HOST_DIR)/usr/bin/genisoimage -r $(TARGET_DIR) | $(HOST_DIR)/usr/bin/create_compressed_fs - 65536 > $$@
endef

define USR_LOCAL_CLOOP_CMD
	$(HOST_DIR)/usr/bin/genisoimage -r $(TARGET_DIR)/usr/local | $(HOST_DIR)/usr/bin/create_compressed_fs - 65536 > $$@
endef
