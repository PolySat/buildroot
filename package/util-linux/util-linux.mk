...
UTIL_LINUX_POST_INSTALL_TARGET_HOOKS+=UTIL_LINUX_MOVE_UTILS_TO_LOCAL

define UTIL_LINUX_MOVE_UTILS_TO_LOCAL
   mkdir -p $(TARGET_DIR)/usr/local/bin
	-mv -f $(TARGET_DIR)/usr/bin/col $(TARGET_DIR)/usr/local/bin
	-mv -f $(TARGET_DIR)/usr/bin/colcrt $(TARGET_DIR)/usr/local/bin
	-mv -f $(TARGET_DIR)/usr/bin/colrm $(TARGET_DIR)/usr/local/bin
	-mv -f $(TARGET_DIR)/usr/bin/column $(TARGET_DIR)/usr/local/bin
	-mv -f $(TARGET_DIR)/usr/bin/pg $(TARGET_DIR)/usr/local/bin
	-mv -f $(TARGET_DIR)/usr/bin/rev $(TARGET_DIR)/usr/local/bin
	-mv -f $(TARGET_DIR)/usr/bin/tailf $(TARGET_DIR)/usr/local/bin
	-mv -f $(TARGET_DIR)/usr/bin/ul $(TARGET_DIR)/usr/local/bin
	-mv -f $(TARGET_DIR)/usr/bin/script $(TARGET_DIR)/usr/local/bin
	-mv -f $(TARGET_DIR)/usr/bin/scriptreplay $(TARGET_DIR)/usr/local/bin
	-mv -f $(TARGET_DIR)/usr/bin/setterm $(TARGET_DIR)/usr/local/bin
	-mv -f $(TARGET_DIR)/usr/bin/cal $(TARGET_DIR)/usr/local/bin
	-mv -f $(TARGET_DIR)/usr/bin/chkdupexe $(TARGET_DIR)/usr/local/bin
	-mv -f $(TARGET_DIR)/usr/bin/look $(TARGET_DIR)/usr/local/bin
	-mv -f $(TARGET_DIR)/usr/bin/lsblk $(TARGET_DIR)/usr/local/bin
	-mv -f $(TARGET_DIR)/usr/bin/mcookie $(TARGET_DIR)/usr/local/bin
	-mv -f $(TARGET_DIR)/usr/bin/whereis $(TARGET_DIR)/usr/local/bin
	-mv -f $(TARGET_DIR)/usr/bin/wipefs $(TARGET_DIR)/usr/local/bin
	-mv -f $(TARGET_DIR)/usr/bin/cytune $(TARGET_DIR)/usr/local/bin
	-mv -f $(TARGET_DIR)/usr/bin/ipcmk $(TARGET_DIR)/usr/local/bin
	-mv -f $(TARGET_DIR)/usr/bin/ipcrm $(TARGET_DIR)/usr/local/bin
	-mv -f $(TARGET_DIR)/usr/bin/ipcs $(TARGET_DIR)/usr/local/bin
	-mv -f $(TARGET_DIR)/usr/bin/lscpu $(TARGET_DIR)/usr/local/bin

   mkdir -p $(TARGET_DIR)/usr/local/sbin
	-mv -f $(TARGET_DIR)/usr/sbin/fsfreeze $(TARGET_DIR)/usr/local/sbin
	-mv -f $(TARGET_DIR)/usr/sbin/fstrim $(TARGET_DIR)/usr/local/sbin
	-mv -f $(TARGET_DIR)/usr/sbin/ldattach $(TARGET_DIR)/usr/local/sbin
	-mv -f $(TARGET_DIR)/usr/sbin/readprofile $(TARGET_DIR)/usr/local/sbin

	-rm -f $(TARGET_DIR)/usr/bin/setarch $(TARGET_DIR)/usr/local/bin
	-rm -f $(TARGET_DIR)/usr/sbin/tunelp $(TARGET_DIR)/usr/local/bin
endef
