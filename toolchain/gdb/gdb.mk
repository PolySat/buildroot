...
$(TARGET_DIR)/usr/local/bin/gdb: $(GDB_TARGET_DIR)/gdb/gdb
	install -c -D $(GDB_TARGET_DIR)/gdb/gdb $(TARGET_DIR)/usr/local/bin/gdb

gdb_target: ncurses $(TARGET_DIR)/usr/local/bin/gdb
...
$(TARGET_DIR)/usr/local/bin/gdbserver: $(GDB_SERVER_DIR)/gdbserver
ifeq ($(BR2_CROSS_TOOLCHAIN_TARGET_UTILS),y)
	...
	install -c -D $(GDB_SERVER_DIR)/gdbserver $(TARGET_DIR)/usr/local/bin/gdbserver

gdbserver: $(TARGET_DIR)/usr/local/bin/gdbserver
